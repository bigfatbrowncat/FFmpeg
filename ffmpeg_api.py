try:
    from sys import LIBAVUTIL_VERSION_MAJOR, AV_PIX_FMT_NB
except ImportError:
...
class AVPixelFormat:
    ...
    YUV422P = 4
    YUV444P = 5
    # TODO: fill others later form pixfmt.h
    NB = 198  # should be the last one, the count of values
...
assert AVPixelFormat.NB == AV_PIX_FMT_NB, "Incompatible ffmpeg and ffmpeg_api"
